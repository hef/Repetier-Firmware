...
- 1 = PID Temperature control. Is better but needs good PID values. Dreefaults are a good start for most extruder.
 Overridden if EEPROM activated.
*/
...
#define EXT0_PID_P   42.57
/** I-gain. Overridden if EEPROM activated.
*/
#define EXT0_PID_I   3.1
/** Dgain.  Overridden if EEPROM activated.*/
#define EXT0_PID_D 146.15
...
/** P-gain.  Overridden if EEPROM activated. */
#define HEATED_BED_PID_PGAIN   911.25
/** I-gain  Overridden if EEPROM activated.*/
#define HEATED_BED_PID_IGAIN   251.66
/** Dgain.  Overridden if EEPROM activated.*/
#define HEATED_BED_PID_DGAIN 824.91
// maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
...
#define X_MAX_LENGTH 367.78
#define Y_MAX_LENGTH 367.78
#define Z_MAX_LENGTH 367.78
...
*/
#define DELTA_RADIUS (PRINTER_RADIUS-END_EFFECTOR_HORIZONTAL_OFFSET-CARRIAGE_HORIZONTAL_OFFSET-1.0)
